...
@Table(name = "bancos", schema = "secundario")
...
//	@OneToMany(mappedBy = "contaBancaria", cascade = CascadeType.ALL, fetch = FetchType.EAGER)
//	@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
//	private List<MovimentacaoBancaria> movimentacoes = new ArrayList<>();
